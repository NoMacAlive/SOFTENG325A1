...
public class ConcertResourceIT {
    ...
    private static final String WEB_SERVICE_URI = "http://localhost:8080/services/concert-service";
    ...
    public void testGetSingleConcert() {
        ...
        System.out.println("Passed first one");
    }
    ...
    public void testSubscriptionForDifferentConcert() throws ExecutionException, InterruptedException {
        ...
        // Users 2 books out a whole theatre - but for a different concert.
